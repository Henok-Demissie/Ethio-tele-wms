...
VALUES (
    ...
    (
        'Telecommunications',
        'Phones, modems, and communication devices'
    ),
    (
        'Cables & Accessories',
        'Various cables, connectors, and accessories'
    ),
    (
        'Power & Backup',
        'UPS systems, batteries, and power equipment'
    ),
    (
        'Tools & Maintenance',
    ...
    (
        'Office Supplies',
        'General office and administrative supplies'
    );
...
VALUES (
        ...
        'RTR-2900-001',
        'Enterprise-grade router for network infrastructure',
        (
            SELECT id
            FROM categories
            WHERE
    ...
    (
        'Ethernet Cable Cat6',
        'CBL-CAT6-001',
        'High-speed ethernet cable 305m roll',
        (
            SELECT id
            FROM categories
            WHERE
    ...
    (
        'UPS 3000VA',
        'UPS-3000-001',
        'Uninterruptible power supply 3000VA capacity',
        (
            SELECT id
            FROM categories
            WHERE
    ...
    (
        'IP Phone Cisco 7841',
        'PHN-7841-001',
        'VoIP desk phone with advanced features',
        (
            SELECT id
            FROM categories
            WHERE
    ...
    (
        ...
        'CBL-FO-SM-001',
        'Single-mode fiber optic cable 1km',
        (
            SELECT id
            FROM categories
            WHERE
...
VALUES (
        'low_stock',
        'Low Stock Alert',
        'Cisco Router 2900 Series is running low on stock',
        'medium',
        (
            SELECT id
            FROM products
