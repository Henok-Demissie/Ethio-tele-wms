    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure warehouse management system settings</p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="company-name" defaultValue="EthioTelecom" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="system-name">System Name</Label>
                  <Input id="system-name" defaultValue="Warehouse Management System" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="company-address">Company Address</Label>
                <Textarea id="company-address" defaultValue="Addis Ababa, Ethiopia" />
              </div>
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="notification-email" type="email" defaultValue="admin@ethiotelecom.et" />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="smtp-server" defaultValue="smtp.ethiotelecom.et" />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="smtp-username" defaultValue="warehouse@ethiotelecom.et" />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="from-email" type="email" defaultValue="warehouse@ethiotelecom.et" />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-muted-foreground">HSL(82.7, 78%, 55.5%)</span>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
